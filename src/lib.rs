...
pub trait OnlineRankingModel {
    ...
    fn user_representation(&self, item_ids: &[ItemId]) -> Self::UserRepresentation;
    fn predict(&self, user: &Self::UserRepresentation, item_ids: &[ItemId]) -> Vec<f32>;
}
...
mod tests {
    ...
    use super::*;
    use data::{train_test_split, user_based_split, Interaction, Interactions};
    use evaluation::{fold_in_mrr_score, mrr_score};
    use test::Bencher;
